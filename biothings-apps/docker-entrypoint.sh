...
# this is full of things that will be overwritten, fix later
...
DATA_ARCHIVE_ROOT = '/data/biothings/APP_NAME/datasources'
DATA_PLUGIN_FOLDER = '/data/biothings/APP_NAME/plugins'
DATA_UPLOAD_FOLDER = '/data/biothings/APP_NAME/dataupload'
...
DIFF_PATH = "/data/biothings/APP_NAME/diff"
...
LOG_FOLDER = "/data/biothings/APP_NAME/logs"
logger = setup_default_log("hub", LOG_FOLDER)

RELEASE_PATH = "/data/biothings/APP_NAME/release"
CACHE_FOLDER = "/data/biothings/APP_NAME/cache"
